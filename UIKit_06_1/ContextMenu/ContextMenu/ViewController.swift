...
class ViewController: UIViewController, UIContextMenuInteractionDelegate {
    ...
    func contextMenuInteraction(_ interaction: UIContextMenuInteraction, configurationForMenuAtLocation configurationForMenuAtLocationlocation: CGPoint) -> UIContextMenuConfiguration? {
    ...
    func contextMenuInteraction(_ interaction: UIContextMenuInteraction, willPerformPreviewActionForMenuWithconfiguration: UIContextMenuConfiguration, animator: any UIContextMenuInteractionCommitAnimating) {
